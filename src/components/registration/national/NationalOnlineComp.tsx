...
const HeaderSection: React.FC = () => (
  <div className="header-section">
    <div className="header-content">
      ...
      <h2 className="event-title">ISF 2026</h2>
    </div>
  </div>
);
...
const InstructionSection: React.FC = () => (
  <div className="instruction-section">
    <h3 className="instruction-title">
      HELLO ISF 2026 PARTICIPANTS, Please consider the following information before filling out the registration form :
    </h3>
...
const InformasiUmumSection: React.FC = () => (
  <section className="form-section">
    ...
    <div className="field-grid">
      ...
      <div className="field-group">
        <label className="field-label">ISF 2026 Competition Information Resources</label>
